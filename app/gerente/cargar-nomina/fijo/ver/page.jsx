...
export default function VerNominaFijos() {
  ...
  useEffect(() => {
    ...
    async function fetchData() {
      try {
        const ref = doc(db, "nominas", "fijos");
  ...
  async function borrarNomina() {
    ...
    try {
      ...
      router.push("/gerente/cargar-nomina/fijo/cargar");
  ...
  return (
    <div className="main">
      ...
      <div className="panelTitle">
        <h1>Ver Nómina - Trabajadores Fijos</h1>
      </div>
      ...
      <div className="card">
        ...
        <div className="buttons">
          ...
          <button
            className="editBtn"
            onClick={() => router.push("/gerente/cargar-nomina/fijo/editar")}
          >
          ...
          <button
            className="addBtn"
            onClick={() => router.push("/gerente/cargar-nomina/fijo/manual")}
          >
