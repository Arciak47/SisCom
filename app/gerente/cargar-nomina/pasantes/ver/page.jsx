...
export default function VerNominaPasantes() {
  ...
  useEffect(() => {
    ...
    async function fetchData() {
      try {
        const ref = doc(db, "nominas", "pasantes");
  ...
  async function borrarNomina() {
    ...
    try {
      await deleteDoc(doc(db, "nominas", "pasantes"));

      await registrarAuditoria(
        "Eliminación de Nómina",
        "Se eliminó por completo la nómina de Pasantes."
      );

      alert("✅ Nómina eliminada");

      router.push("/gerente/cargar-nomina/pasantes/cargar");
    ...
    <div className="main">
      ...
      <div className="card">
        ...
        <div className="buttons">
          ...
          <button
            className="editBtn"
            onClick={() => router.push("/gerente/cargar-nomina/pasantes/editar")}
          >
          ...
          <button
            className="addBtn"
            onClick={() => router.push("/gerente/cargar-nomina/pasantes/manual")}
          >
