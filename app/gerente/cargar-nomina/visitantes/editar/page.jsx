...
export default function EditarVisitantes(){
  ...
  function eliminar(index){
    ...
    const confirmacion = confirm("¿Eliminar visitante?");
  ...
  async function guardar(){
    ...
    try{
      ...
      await registrarAuditoria(
        ...
        `Se guardaron cambios y modificaciones en la nomina de Visitantes (total registros: ${data.length}).`
      );
  ...
  return(
    ...
    <div className="main">
      ...
      <div className="panelTitle">
        <h1>Editar Nómina - Visitantes</h1>
      </div>
