...
export default function VerNominaVisitantes() {
  ...
  useEffect(() => {
    ...
    async function fetchData() {
      try {
        const ref = doc(db, "nominas", "visitantes");
  ...
  async function borrarNomina() {
    ...
    const ok = confirm("¿Eliminar toda la nómina de visitantes?");
    if (!ok) return;

    try {
      await deleteDoc(doc(db, "nominas", "visitantes"));

      await registrarAuditoria(
        "Eliminación de Nómina",
        "Se eliminó por completo la nómina de Visitantes."
      );

      alert("✅ Nómina eliminada");

      router.push("/gerente/cargar-nomina/visitantes/cargar");
    ...
    <div className="main">
      ...
      <div className="card">
        ...
        <div className="buttons">
          ...
          <button
            className="editBtn"
            onClick={() => router.push("/gerente/cargar-nomina/visitantes/editar")}
          >
          ...
          <button
            className="addBtn"
            onClick={() => router.push("/gerente/cargar-nomina/visitantes/manual")}
          >
