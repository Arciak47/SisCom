    ...
    <div className="sl-layout">
      {toast && (
        <div className="sl-toast" onClick={() => {
          const role = window.location.pathname.split('/')[1] || "gerente";
      ...
      <aside className={`sl-sidebar ${menuAbierto ? "open" : ""}`}>
        ...
        <div className="sl-top">
          ...
          <nav className="sl-nav">
            ...
            <a className="sl-item" onClick={() => { router.push("/gerente"); setMenuAbierto(false); }}>
              <Home size={18}/><span>Dashboard</span>
            </a>

            <a className="sl-item" onClick={() => { router.push("/gerente/nomina"); setMenuAbierto(false); }}>
              <Users size={18}/><span>Nómina</span>
            </a>

             <a className="sl-item" onClick={() => { router.push("/gerente/chat"); setMenuAbierto(false); }}>
            ...
            <a className="sl-item" onClick={() => { router.push("/gerente/perfil"); setMenuAbierto(false); }}>
