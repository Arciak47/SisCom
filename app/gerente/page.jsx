...
export default function PanelPrincipal() {
    ...
    const unsubscribe = onAuthStateChanged(auth, async (user) => {
      ...
      if (user) {
        try {
          ...
          console.error("Error al obtener datos del dashboard gerente:", e);
        }
      } else {
        router.push("/login");
      }
  ...
  useEffect(() => {
    async function fetchPeriodStats() {
      ...
      try {
        ...
        console.error("Error fetching period stats for gerente:", e);
      }
  ...
  const reporteOpciones = [
    { icon: <FileText size={20} />, label: "Reporte Diario", desc: "Asistencia de hoy", route: "/gerente/reportes/diario", color: "#3182ce" },
    { icon: <BarChart3 size={20} />, label: "Reporte Semanal", desc: "Últimos 7 días", route: "/gerente/reportes/semanal", color: "#319795" },
    { icon: <PieChart size={20} />, label: "Reporte Mensual", desc: "Por mes específico", route: "/gerente/reportes/mensual", color: "#dd6b20" },
    { icon: <TrendingUp size={20} />, label: "Reporte Anual", desc: "Por año de registro", route: "/gerente/reportes/anual", color: "#805ad5" }
  ];
    ...
    <div className="pg-container">
      ...
      <div className="welcome-banner">
        <div className="welcome-info">
          ...
          <div>
            <h1 className="welcome-title">Bienvenido, <span className="manager-name">{nombreUsuario}</span></h1>
            <p className="welcome-subtitle">Gerente General · Consola de Control de Nómina y Comedor</p>
          </div>
        </div>
