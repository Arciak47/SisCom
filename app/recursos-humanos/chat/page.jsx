...
export default function RRHHChat() {
  ...
  async function handleSendMessage(e) {
    ...
    try {
      await addDoc(collection(db, "mensajes"), {
        ...
        emisorNombre: currentUser.displayName || "RRHH",
    ...
    <div className="chatLayout">
      ...
      <aside className="sidebarChat">
        <div className="headerSidebar">
          <button className="volverBtn" onClick={() => router.push("/recursos-humanos")}>
      ...
      <style jsx>{`
        ...
        .msgCheck.read {
          color: #38bdf8; /* WhatsApp-like read blue checks */
        }

        .msgCheck.unread {
          color: rgba(255, 255, 255, 0.6); /* Soft grey double checks when unread on mine */
        }
