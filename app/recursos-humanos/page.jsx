...
export default function PanelRRHH() {
    ...
    const unsubscribe = onAuthStateChanged(auth, async (user) => {
      ...
      if (user) {
        try {
          ...
          console.error("Error al obtener datos del dashboard rrhh:", e);
        }
      } else {
        router.push("/login");
      }
  ...
  useEffect(() => {
    async function fetchPeriodStats() {
      ...
      try {
        ...
        console.error("Error fetching period stats for rrhh:", e);
      }
  ...
  const reportes = [
    { icon: <FileText size={20}/>, label: "Reporte Diario", desc: "Asistencia de hoy", route: "/recursos-humanos/reportes/diario", color: "#3182ce" },
    { icon: <BarChart3 size={20}/>, label: "Reporte Semanal", desc: "Últimos 7 días", route: "/recursos-humanos/reportes/semanal", color: "#319795" },
    { icon: <PieChart size={20}/>, label: "Reporte Mensual", desc: "Por mes específico", route: "/recursos-humanos/reportes/mensual", color: "#dd6b20" },
    { icon: <TrendingUp size={20}/>, label: "Reporte Anual", desc: "Por año de registro", route: "/recursos-humanos/reportes/anual", color: "#805ad5" }
  ];
    ...
    <div className="pg-container">
      ...
      <div className="welcome-banner">
        <div className="welcome-info">
          ...
          <div>
            <h1 className="welcome-title">Bienvenido, <span className="rrhh-name">{nombreUsuario}</span></h1>
            <p className="welcome-subtitle">Recursos Humanos · Consola de Control de Nómina y Comedor</p>
          </div>
        </div>
